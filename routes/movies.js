...
//   new Movies(req.body).save();
//   res.status(200).send(`Movies: ${req.body.first_name} ${req.body.last_name} Added`);
// });
//
...
//       }
//
//       movies.set(updates).save().then(() => {
//         res.status(200).send(`Movies(${req.params.id}): ${req.body.first_name} ${req.body.last_name} Updated`);
//       });
//     } else {
//       res.status(404).send("not found");
//     }
