...
//   new Actors(req.body).save();
//   res.status(200).send(`Actor: ${req.body.first_name} ${req.body.last_name} Added`);
// });
//
// // UPDATE A ACTOR WITH ID=?
// router.patch('/:id', function(req, res, next) {
//   Actors.where({ id: req.params.id }).fetch()
//   .then((actor) => {
//     if (actor !== null) {
//       let updates = {};
//
...
//       }
//
//       actor.set(updates).save().then(() => {
//         res.status(200).send(`Actor(${req.params.id}): ${req.body.first_name} ${req.body.last_name} Updated`);
//       });
//     } else {
//       res.status(404).send("not found");
//     }
...
// // // DELETE A ACTOR WITH ID=?
// router.delete('/:id', function(req, res, next) {
//   Actors.where({ id: req.params.id }).destroy()
//   .then(() => {
//     res.status(200).send("Actor deleted.");
//   });
// });
